...
define( 'ALPHA_ORTTO_ADDON_VERSION', '1.5.0-rc.2' );
...
require_once __DIR__ . '/includes/class-alpha-ortto-account-sf-id-updater.php';

add_action( 'gform_loaded', array( 'Alpha_Ortto_AddOn_Bootstrap', 'load' ), 5 );

Alpha_Ortto_SF_ID_Converter::init();
Alpha_Ortto_Account_SF_ID_Updater::init();
